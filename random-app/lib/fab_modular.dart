...
import 'features/page_one.dart'; // Import the pages
import 'features/page_two.dart';
import 'features/page_three.dart';
...
class _FabPanelPageState extends State<FabPanelPage>
  ...
  MainView currentView = MainView.pageOne; // Fixed: Changed from audioPlayer to pageOne

  final List<MenuItem> menuItems = const [
    MenuItem(icon: Icons.music_note, label: 'Page 1', view: MainView.pageOne),
    MenuItem(icon: Icons.videocam, label: 'Page 2', view: MainView.pageTwo),
    MenuItem(icon: Icons.settings, label: 'Page 3', view: MainView.pageThree),
  ];
  ...
  Widget buildMainView() {
    switch (currentView) {
      case MainView.pageOne:
        return const PageOne(); // Use the imported PageOne widget
      case MainView.pageTwo:
        return const PageTwo(); // Use the imported PageTwo widget
      case MainView.pageThree:
        return const PageThree(); // Use the imported PageThree widget
    }
  }
