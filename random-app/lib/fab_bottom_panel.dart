...
class _FabPanelPageState extends State<FabPanelPage>
  ...
  final List<MenuItem> menuItems = const [
    MenuItem(icon: Icons.code, label: 'Download And Convert', view:
MainView.downloadAndCovert),
    MenuItem(icon: Icons.code, label: 'Audio Player', view:
MainView.audioPlayer),
    MenuItem(icon: Icons.code, label: 'Lyrics Editor', view:
MainView.lyricsEditor),
    MenuItem(icon: Icons.code, label: 'Asset View', view:
      MainView.assetView),
    MenuItem(icon: Icons.code, label: 'Optimized Export', view:
      MainView.optimizedExport),
  ];
  ...
  Widget buildMainView() {
    switch (currentView) {
      case MainView.downloadAndCovert:
        return const Center(child: Text('Page Download and Covert'));  
      case MainView.audioPlayer:
        return const Center(child: Text('Page Audio Player'));
      case MainView.lyricsEditor:
        return const Center(child: Text('Page Lyrics Editor'));
      case MainView.assetView:
        return const Center(child: Text('Page Asset View'));
      case MainView.optimizedExport:
        return const Center(child: Text('Page Optimized Export'));
    }
  }
